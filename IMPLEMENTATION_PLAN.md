...
- [ ] **`RT-MOD-BANK`** — the single highest-value thing left. It blocks taxes, upkeep, plot sales, claim costs, spawn costs and the ruin reclaim price, all of which are already written up as outstanding elsewhere in this file
