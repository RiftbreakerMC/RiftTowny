...
-- and a coordinate.
--
-- x, y and z are REAL rather than integers. A spawn is a standing position, not a block: rounding it
-- would put arrivals in the corner of a block and, on a half-slab or a stair, inside one.
