...
-- Without it, "has it run recently" is a race with a comparison in it. On MariaDB this is the case
-- that actually matters, because a shared database is what MariaDB is here for.
--
...
CREATE TABLE rt_tax_run (
    ...
    finished_at       BIGINT,
    towns_charged     INT         NOT NULL DEFAULT 0,
    residents_charged INT         NOT NULL DEFAULT 0,
    towns_fallen      INT         NOT NULL DEFAULT 0,
...
ALTER TABLE rt_town ADD COLUMN unpaid_since BIGINT NULL;
