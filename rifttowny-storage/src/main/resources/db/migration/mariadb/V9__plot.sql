...
ALTER TABLE rt_claim
    ADD COLUMN plot_type VARCHAR(16) NOT NULL DEFAULT 'DEFAULT',
    ADD COLUMN owner_id CHAR(36) NULL,
    -- "Which plots does this resident hold" is asked whenever somebody leaves a town, and by the
    -- plot listing. Without an index it is a scan of every claim on the server.
    ADD INDEX idx_rt_claim_owner (owner_id);
